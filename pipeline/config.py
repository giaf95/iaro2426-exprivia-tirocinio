...
PROTOTYPE_DIR = os.path.dirname(CONFIG_DIR)                  
ROOT_DIR = os.path.dirname(PROTOTYPE_DIR)                     

# 2. CARICHIAMO IL FILE .ENV
ENV_PATH = os.path.join(ROOT_DIR, '.env')
load_dotenv(dotenv_path=ENV_PATH)

# 3. Definiamo la cartella data CORRETTA
VERA_PIPELINE_DIR = os.path.join(ROOT_DIR, 'pipeline')
DATA_DIR = os.path.join(VERA_PIPELINE_DIR, 'data')
